...
// Owl Carousel  Js
document.writeln('<script src="assets/js/carousel-thumbs.js" type="text/javascript"></script>');

// AOS  Js
document.writeln('<script src="assets/js/aos.js" type="text/javascript"></script>');

// Tilt  Js
document.writeln('<script src="assets/js/tilt.jquery.js" type="text/javascript"></script>');
